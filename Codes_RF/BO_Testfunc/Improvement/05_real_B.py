...
# 1/3 scripts to make a comparison between new developed algorithm and tradtional algorithm
# samples whole domain to have a function for comparison
...
os.system(f"cd runtime_data")
append_to_csv(f'runtime_data/Real_pre.csv', [sampled_input])
...
saveList(pred,'runtime_data/pred_Real.npy')
...
saveList(pred_aus,'runtime_data/pred_aus_Real.npy')
